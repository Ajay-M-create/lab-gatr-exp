...
if __name__ == "__main__":
    ...
    # Initialize dataset with 'area' target
    ...
    plt.savefig('./loss_curves/GATR_loss_curves_surface_area.png')
    plt.close()
    
    print("Loss curves have been saved to ./loss_curves/GATR_loss_curves_surface_area.png") 