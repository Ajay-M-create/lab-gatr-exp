...
if __name__ == "__main__":
    ...
    # Initialize dataset with 'vertices' target
    ...
    plt.savefig('./loss_curves/GATR_loss_curves_num_vertices.png')
    plt.close()
    
    print("Loss curves have been saved to ./loss_curves/GATR_loss_curves_num_vertices.png") 