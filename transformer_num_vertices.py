...
class ConvexHullDataset(Dataset):
    def __init__(self, data_dir, target='volume'):
                ...
                if points.shape[0] < 4:
                    ...
                    try:
                        ...
                        if self.target == 'vertices':
                            ...
                            # Inradius computation is non-trivial; placeholder
...
dataset = ConvexHullDataset(data_dir, target='vertices')
...
if __name__ == "__main__":
    ...
    plt.xlabel('Epoch')
    plt.ylabel('Loss')
    plt.title('Training and Testing Losses over Epochs - Number of Vertices')
    plt.legend()
    plt.grid(True)
    
    # Save the plot as a .png file
    plt.savefig('./loss_curves/Transformer_loss_curves_num_vertices.png')
    plt.close()
    
    print("Loss curves have been saved to ./loss_curves/Transformer_loss_curves_num_vertices.png") 