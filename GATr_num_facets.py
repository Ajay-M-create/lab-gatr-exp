...
class ConvexHullDataset(Dataset):
    def __init__(self, data_dir, target='facets'):
...
if __name__ == "__main__":
    ...
    # Initialize dataset with 'facets' target
    dataset = ConvexHullDataset(data_dir, target='facets')
    ...
    plt.xlabel('Epoch')
    plt.ylabel('Loss')
    plt.title('Training and Testing Losses over Epochs - Number of Facets')
    plt.legend()
    plt.grid(True)
    
    # Save the plot as a .png file
    plt.savefig('./loss_curves/GATR_loss_curves_num_facets.png')
    plt.close()
    
    print("Loss curves have been saved to ./loss_curves/GATR_loss_curves_num_facets.png") 